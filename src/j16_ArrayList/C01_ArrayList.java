...
public class C01_ArrayList {
    ...
    Collections ==> Bir araya getirilmis parcalar anlamına gelir. ArrayList, Set, Vector, Queue ler java collections sınıfı nesneleridir.
        */
        ...
        ArrayList<String> listIsim=new ArrayList<>(Arrays.asList("Muharrem","Nur","Enise","Bekir"));
        ...
        listSayi.add(2,14);// List de index 2 ye 14 değerini ekleyecek. 2. indexteki eski eleman 1 index ileri kayar
